...
- **Stacked View**: New buffers appear in horizontal splits above, with configurable max visible
...
require('piper').setup({
  ...
  -- New buffers appear in a split above; bottommost closes when exceeded
  max_visible = 3,
})
```
